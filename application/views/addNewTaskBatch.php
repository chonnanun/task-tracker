            ...
            <div class="col-md-10">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <?php
                        if(empty($task['id'])) {
                            $formURL = base_url().'task/addNewTask/batch';
                        } else {
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="fname">Multi Title / HAWB / Reference No <br>(One line per one HAWB)</label>
                                        <textarea name="title" class="form-control required" id="description" name="description" style="width:100% ;height:150px;" autofocus></textarea>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" class="form-control required" id="description" name="description" style="width:100% ;height:150px;"><?= $task['description'] ?></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" id="assign"  name="assign" maxlength="100" value="<?= $task['assigned'] ?>">
                                    </div>
                                </div>
...
<!--                                --><?php //print_r($customfields->fields); ?>
                                ...
                                <?php
                                    $colwidth = 6;
                                    $minicols = ["Agent","chequeNo","chequeDate","dutyChequeNo","dutyChequeDate"];
                                    $microcols = ["shift","refNo","preCaseNo","preCaseDate","preCaseCloseDate","caseNo","caseDate","caseCloseDate","importDate","paidby","dutyPaidby","chequeStatus","dutyChequeStatus","dutyAmount","amount"];
                                    $supermicro = ["CAT"];
...
//                                                    print_r($val);
                                                    if(!empty($val))
                                                    {
                                                        ...
                                                        {
                                                            ?>
                                                            <option value="<?php echo $v ?>" <?php if(is_object($task['customfield'])) if($task['customfield']->$key == $v) echo "selected=selected"; ?>><?php echo $v ?></option>
                                                            <?php
                                                        }
                                                    }
                                                    ?>
                                    ...
                                    <?php } else { ?>
                                    <?php if($key == "preCaseNo" || $key == "caseNo" || $key == "chequeNo" || $key == "dutyChequeNo") { ?>
                                <div class="col-md-12" style="clear:both;height: 20px;"></div>
                                    <?php } ?>
                                <div class="col-md-<?= $colwidth ?>">
                                    <div class="form-group">
                                        <label for="assign"><?= $function->showKey($key) ?></label>
                                        <input type="text" class="form-control required" id="custom-<?= $key ?>"  name="custom[<?= $key ?>]" value="<?php if(is_object($task['customfield'])) echo $task['customfield']->$key; ?>">
                                    </div>
                                </div>
                                <?php } } ?>
            ...
            <div class="col-md-4" style="display: none">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box box-primary">
                            <div class="box-header">
                                <h3 class="box-title">Task Adding Manual</h3>
                            </div><!-- /.box-header -->
                            <div class="box-body">
                                instruction here
                            </div>
