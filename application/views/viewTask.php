                            ...
                            <?php if(!empty($customfields)){ ?>
                                <div class="row">
                                    ...
                                    <?php
                                        $colwidth = 6;
                                        $minicols = ["Agent"];
                                        $microcols = ["shift","refNo","preCaseNo","preCaseDate","preCaseCloseDate","caseNo","caseDate","caseCloseDate","chequeNo","amount","importDate","paidby","dutyChequeNo","dutyAmount","dutyPaidby"];
                                        $supermicro = ["CAT"];
...
//        };
        ...
        $("#syncnow").click(function() {
            ...
            var jqxhr = $.getJSON( "http://23.168.85.47:8081/task-tracker/nbapi/gethawb/"+hawb, function() {
              console.log( "success" );
            })
              .done(function(data) {
                console.log( data );
