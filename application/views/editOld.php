                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="email" placeholder="Enter email" name="email" value="<?php echo $email; ?>" maxlength="128">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="group" name="group">
                                            ...
                                            if(!empty($groups))
                                            {
                                                ...
                                                {
                                                    ?>
                                                    <option value="<?php echo $group->id; ?>" <?php if($group->id == $groupId) {echo "selected=selected";} ?>><?php echo $group->group_name_EN ?> (<?php echo $group->group_name_TH ?>)</option>
                                                    <?php
                                                }
                                            }
                                            ?>
