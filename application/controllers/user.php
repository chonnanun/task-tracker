...
class User extends BaseController
{
    ...
    function addNewUser()
    {
        ...
        else
        {
            ...
            $this->form_validation->set_rules('mobile','Mobile Number','xss_clean');
    ...
    function editUser()
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    $userInfo = array('email'=>$email, 'password'=>getHashedPassword($password), 'roleId'=>$roleId, 'groupId'=>$groupId,
